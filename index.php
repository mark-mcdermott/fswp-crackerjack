...
<body class="home">
  ...
  <main>
      ...
      -->
<h2>How to transfer files to and from Amazon EC2 with scp</h2><p>Transferring files through the terminal can be a real pain, compared to a drag and drop GUI like Filezilla.  But when you know the syntax, it gets a lot easier.  When you are uploading/downloading files to an amazon EC2 ubuntu box, you'll need the pemfile location on your computer.</p>
